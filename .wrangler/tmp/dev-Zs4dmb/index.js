...
// .wrangler/tmp/bundle-CVJ76X/checked-fetch.js
...
// .wrangler/tmp/bundle-CVJ76X/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-CVJ76X/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post("/", async (c2) => {
  ...
  try {
    ...
    if (flaggedFor.size > 0) {
      const sorted = Array.from(flaggedFor).sort((a2, b) => a2.score > b.score ? -1 : 1)[0];
      return c2.json({
        isProfanity: true,
        score: sorted.score,
      ...
      const mostProfaneChunk = vectorRes.sort((a2, b) => a2.score > b.score ? -1 : 1)[0];
      return c2.json({
        isProfanity: false,
...
var profanity_norsk_default = app;
...
// .wrangler/tmp/bundle-CVJ76X/middleware-insertion-facade.js
profanity_norsk_default.middleware = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default,
  ...profanity_norsk_default.middleware ?? []
].filter(Boolean);
var middleware_insertion_facade_default = profanity_norsk_default;
